...
import frc.robot.commandGroups.Collects;
...
public class RobotContainer {
  ...
  private final Elivator m_elivator = new Elivator();
  ...
  public Command getSetElivatorCommand(vicStates state) {
    // An ExampleCommand will run in autonomous
     
    return new SetElivatorState(m_elivator, state);
  }
  public Command getSetCollects(){
    return new Collects(m_elivator, m_arm,m_rollers);
  }
}
